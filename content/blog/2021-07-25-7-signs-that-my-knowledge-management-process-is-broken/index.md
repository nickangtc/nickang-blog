...
ai_summary: "The post argues that the author's personal knowledge management system is failing, shown by habits such as not taking notes while reading, not revisiting daily notes, not linking ideas, forgetting the workflow, and rarely using notes to deepen understanding. The main point is that the current process has devolved into simple note-taking rather than a system for learning, reflection, and knowledge growth, which is leaving the author with forgotten ideas and little intellectual progress outside work. The author concludes by considering a move from Bear to Obsidian in the hope that a better tool will help rebuild a more effective knowledge-processing habit."
---
