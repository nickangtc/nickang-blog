...
3. semantic search algo (searching by meaning of words/sentences/documents)
...
![without RAG illustration flow](./images/without-rag.jpg)
_Plain old input in, output out._
...
![with RAG illustration flow](./images/with-rag.jpg)
_With RAG, the user prompt is augmented with the most relevant documents before output out._
...
So RAG is definitely an important technique for AI engineers and FDEs to understand, and the pipeline above is the study roadmap.

As with all concepts, when you double-click, all sorts of interestingness ooze out. I will bring some of that milk in the next post where I'll double-click on search algos powering RAG pipelines.
